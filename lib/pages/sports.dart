...
import 'package:newsappcourse/details_news%20page.dart';
import 'package:newsappcourse/model/busness.dart';
...
class _sportsState extends State<sports> {
  ...
  void initState() {
    super.initState();
    news=networkapi.fetchbusiness(URL: 'https://newsapi.org/v2/top-headlines?country=us&category=sports&apiKey=74587a67db6c4be6a27571bdb04de140') as Future<business>? ;
  }
