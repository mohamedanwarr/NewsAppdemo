...
class _businesspageState extends State<businesspage> {
  ...
  void initState() {
    super.initState();
    news=networkapi.fetchbusiness( URL: 'https://newsapi.org/v2/top-headlines?country=us&category=business&apiKey=74587a67db6c4be6a27571bdb04de140') as Future<business>? ;
   }
